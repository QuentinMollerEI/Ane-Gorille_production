...
export default function BuyerDocumentsTable({ documents = [] }) {
                    ...
                    >
                      ...
                      <td className="p-4 text-right space-x-2">
                        <button
                          ...
                          title="Télécharger la facture certifiée au format PDF"
                        >
                          <Download size={15} />
                        </button>
                        {doc.isChorus && (
                          <button
                            ...
                            title="Télécharger la facture au format Factur-X XML"
                          >
                            Factur-X
                          </button>
                        )}
